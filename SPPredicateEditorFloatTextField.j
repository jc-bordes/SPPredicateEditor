/*
 * SPPredicateEditorFloatTextField.j
 * AppKit
 *
...
@implementation SPPredicateEditorUnsignedFloatTextField : CPTextField
{
}
...
@implementation SPPredicateEditorFloatTextField : CPTextField
{
}
